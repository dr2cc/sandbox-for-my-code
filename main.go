...
//06.05.25 Уже не знаю зачем эта ветка, видимо свое, как тест она сделала.
//Ветвь main изменил по наработкам на рабочем компе.
//Думаю все это уже лишнее, раз основной репозиторий проходит автотесты
import (
	"errors"
	"fmt"
	"io"
